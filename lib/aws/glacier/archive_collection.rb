  ...
  class Glacier
    ...
    class ArchiveCollection
      ...
      def convert_to_io data
        ...
        if data.is_a?(Pathname) or data.is_a?(String) # path to file on disk
          file_opts = ['rb']
          file_opts << { :encoding => "BINARY" } if Object.const_defined?(:Encoding)
          return File.open(data.to_s, *file_opts)
        end
        ...
        msg = "Expected data to be a File, Pathname, IO object or string."
